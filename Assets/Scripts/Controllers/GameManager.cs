...
public class GameManager : MonoBehaviour
{
    ...
    public void LoadLevel(eLevelMode mode)
    {
        ...
        m_gameOverStarted = false;
        State = eStateGame.GAME_STARTED;
    }

    public void GameOver()
    {
        if (m_state == eStateGame.GAME_OVER || m_state == eStateGame.GAME_WIN) return;
    ...
    private bool m_gameOverStarted = false;

    private IEnumerator WaitBoardController(bool isWin)
    {
        if (m_gameOverStarted) yield break;
